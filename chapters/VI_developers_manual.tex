...
Domyślnie zarówno nazwa użytkownika, jak i hasło, to \texttt{admin}. Te
wartości można (i zaleca się) skonfigurować przed pierwszym uruchomieniem
aplikacji poprzez plik zmiennych środowiskowych \texttt{.env}.
